...
Route::post('codigos/gestionBodega','CodigoLibrosController@gestionBodega');
...
Route::post('codigos/devolucion','CodigoLibrosController@devolucionCodigos');
...
//para traer el periodo por institucion
Route::get('traerPeriodoInstitucion/{institucion}','UsuarioController@traerPeriodoInstitucion');
//==============API CAPACITACIONES=============================
...
Route::get('codigos_libros_docente/{anio}/{docente}','CodigosLibrosController@codigos_libros_docente');
Route::get('codigos_libros_estudiante/{curso}/','CodigosLibrosController@codigos_libros_estudiante');
...
Route::get('getFilesTarea','EstudianteController@getFilesTarea');
...
Route::get('getevaluacionesDocente','EvaluacionController@evaluacionesDocente');
...
Route::get('verCalificacionEval/{id}/{materia}/{quimestre}','EvaluacionController@verCalificacionEval');
...
Route::get('anular_pedido_asesor/{id_pedido}/{id_usuario}','PedidosController@anular_pedido_asesor');
...
Route::get('guardar_total_pedido/{id_pedido}/{total_usd}/{total_unid}','PedidosController@guardar_total_pedido');
...
Route::post('eliminar_beneficiario_pedido/{id_beneficiario}','PedidosController@eliminar_eliminar_beneficiario_pedido');
...
//============FIN EVIDENCIA==================
//============PARALELOS=====================================
Route::post('guardarParalelo','EstudianteController@guardarParalelo');
//=========APIS PARALELOS =================================
//============CURSOS JAIL=====================================
Route::get('getCursosAsignados','EstudianteController@getCursosAsignados');
Route::get('getCursosInstitucionxPeriodo/{institucion}/{periodo}','CursoJailController@getCursosInstitucionxPeriodo');
Route::resource('cursosjail','CursoJailController');
Route::get('estudiantexCurso/{curso}','CursoJailController@estudiantexCurso');
Route::post('changeQuimestre','CursoJailController@changeQuimestre');
Route::get('resumenCalificaciones','CursoJailController@resumenCalificaciones');
Route::get('generarFormatoCalificaciones','CursoJailController@generarFormatoCalificaciones');
Route::get('generateFormatoTareas','CursoJailController@generateFormatoTareas');
//=========FIN CURSOS JAIL =================================
//=========MATRICULA===================================
Route::post('asignarEstudianteToPendiente','CursoJailController@asignarEstudianteToPendiente');
Route::post('guardarMatricula','CursoJailController@guardarMatricula');
//=========FIN MATRICULA
//============CONFIGURACION=================================
Route::post('guardarConfiguracion','CursoJailController@guardarConfiguracion');
Route::post('guardarConfiguracionQuimestre','CursoJailController@guardarConfiguracionQuimestre');
Route::get('FormatoReportePensiones','CursoJailController@FormatoReportePensiones');
Route::get('ReportePensiones','CursoJailController@ReportePensiones');
//==============FIN CONFIGURACION==========================
//==============CLASES======================================
Route::get('zoom','CursoJailController@zoom');
Route::post('zoom','CursoJailController@guardarzoom');
Route::post('deletezoom','CursoJailController@deletezoom');
///=============FIN CLASES ==============================
//==================HORARIOS===================================
Route::resource('horario','HorarioController');
Route::post('asignarDocenteCurso','HorarioController@asignarDocenteCurso');
Route::post('guardarConfiguracionHorario','HorarioController@guardarConfiguracionHorario');
Route::post('validarConfiguracionHorario','HorarioController@validarConfiguracionHorario');
Route::post('generarHorario','HorarioController@generarHorario');
Route::post('quitarMateriaHorario','HorarioController@quitarMateriaHorario');
Route::post('changeMateriaHorario','HorarioController@changeMateriaHorario');
Route::post('desactivarHorario','HorarioController@desactivarHorario');
//===================HORARIOS=================================
Route::resource('prueba','PruebaController');
Route::post('guardarPrueba','PruebaController@guardarPrueba');
//===================COMUNICACIONES=============================
Route::resource('comunicaciones','ComunicacionesController');
Route::get('listadoComunicaciones','ComunicacionesController@listadoComunicaciones');
