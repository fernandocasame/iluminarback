...
class  PaquetesRepository extends BaseRepository
{
    ...
    public function procesoGestionBodega($numeroProceso,$codigo,$codigo_union,$request,$factura,$codigoPaquete){
        //numero proceso => 0 = usan y liquidan; 1 = venta lista; 2 = regalado; 3 regalado y bloqueado; 4 = guia;
        $estadoIngreso       = 0;
        $codigoU             = $this->codigosRepository->procesoUpdateGestionBodega($numeroProceso,$codigo_union,$codigo,$request,$factura,$codigoPaquete);
        if($codigoU) $codigo = $this->codigosRepository->procesoUpdateGestionBodega($numeroProceso,$codigo,$codigo_union,$request,$factura,$codigoPaquete);
