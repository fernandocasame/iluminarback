...
class DocenteController extends Controller
{
    ...
    public function docentesInstitucion($id)
    {
        ...
        ->where('id_group',6)
        ->get([DB::RAW("CONCAT(nombres, ' ',apellidos ) as docente"),'idusuario', 'cedula', 'nombres', 'apellidos', 'name_usuario', 'email', 'telefono', 'estado_idEstado', 'id_group', 'institucion_idInstitucion','foto_user']);
        return $usuarios;
    }
