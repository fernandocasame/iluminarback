...
class GestionCodigosController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        //guardar
            ...
            $this->GuardarEnHistorico($request->user_created,$request->institucion_id,$request->periodo_id,$request->codigo,$request->user_created,$comentario);
    ...
    public function eliminarCode(Request $request){
        ...
        if($eliminar){
            ...
            //Guardar en el historico
            $this->GuardarEnHistorico($usuario_editor,$request->institucion_id,$request->periodo_id,$request->codigo,$usuario_editor,$comentario);
